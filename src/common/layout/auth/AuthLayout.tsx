    ...
    <>
      ...
      <div className="flex flex-col-reverse gap-4 md:flex-row">
        ...
        <div className="flex flex-col justify-center w-full md:w-1/2">
          <div className="mt-4 app-container">
            <div className="flex items-center justify-center w-full mb-4 sm:mb-5 md:mb-6 lg:mb-7 xl:mb-8 2xl:mb-9">
              {isPasswordSuccess ? (
                <img
        ...
        <div className="w-full h-screen md:w-1/2 ">
          <img src="/images/auth-decorations.png" className="w-full h-full" />
        </div>
      </div>
    </>
  );
