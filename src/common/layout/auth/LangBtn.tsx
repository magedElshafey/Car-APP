...
const LangBtn = () => {
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 z-50 flex items-center justify-center gap-2 p-2 rounded-md bg-white/90 backdrop-blur-sm text-gray hover:bg-white shadow-md border border-border transition-all ${
