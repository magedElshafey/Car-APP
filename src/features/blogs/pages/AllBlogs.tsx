...
//   /* =========================
//      Prepare categories for MainSelect
//   ========================= */
//   const selectCategories: SelectCategory[] = useMemo(() => {
//     const mapped = categories.map((c, index) => ({
//       id: index + 1,
//       name: `${c.name} (${c.blogs_count})`,
//       slug: c.slug,
//     }));
...
//     const found = selectCategories.find((c) => c.slug === cat);
...
//           <div className="space-y-6 containerr">
//             {/* ================= Header ================= */}
...
//             {/* ================= Filters ================= */}
//             <div className="p-4 border rounded-card border-border-subtle bg-bg-surface shadow-soft">
...
//                   <div className="p-6 text-center border rounded-card border-border-subtle bg-bg-surface">
