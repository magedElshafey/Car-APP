...
//       : "absolute inset-0 bg-gradient-to-l from-black/72 via-black/40 to-transparent";
...
//             initial={
//               prefersReducedMotion ? false : { opacity: 0.92, scale: 1.015 }
//             }
...
//             ) : (
//               <>
//                 {/* soft background fill to avoid ugly empty space */}
//                 <img
//                   src={activeMedia.src}
//                   alt=""
//                   aria-hidden="true"
//                   loading="lazy"
//                   decoding="async"
//                   className="absolute inset-0 object-cover w-full h-full scale-110 blur-2xl opacity-35"
//                 />

//                 {/* main media: full image visible without cropping */}
//                 <img
//                   src={activeMedia.src}
//                   alt={activeMedia.alt ?? ""}
//                   loading="lazy"
...
//   return (
//     <div className="relative z-[1] flex min-h-[240px] items-center justify-end p-5 md:min-h-[320px] md:p-8">
